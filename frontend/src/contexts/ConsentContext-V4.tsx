...
export const ConsentProvider: React.FC<Props> = ({ children }) => {
  ...
  const rejectAll = async () => {
    await rejectConsent(); // reuse logic
  };
    ...
    >
      ...
      >
        <DialogTitle sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          {!setup ? t("Privacy Notice") : t("Consents Handling")}
          {setup && (
        ...
        <DialogActions sx={{ justifyContent: "flex-end", gap: 1 }}>
          {!setup ? (
            <>
              ...
              <Button variant="text" color="inherit" sx={{ whiteSpace: "nowrap" }} onClick={openConsentDialog}>
