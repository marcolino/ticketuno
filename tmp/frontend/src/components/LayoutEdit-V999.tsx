...
const LayoutEdit: React.FC = () => {
  ...
  const { t } = useTranslation();
   ...
   // Get the theater data and return path from navigation state
  const { theaterData, returnTo } = location.state || {};
  ...
  const handleSaveLayout = async () => {
    try {
      ...
      //const newLayout = await saveLayout(layoutData);
