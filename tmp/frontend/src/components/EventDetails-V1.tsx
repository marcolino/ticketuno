  ...
  return (
    <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
      ...
      {performances.length === 0 ? (
        <Alert severity="info">
          {t('No upcoming performances scheduled at this time. Please check back later.')}
        </Alert>
      ) : (
        <Grid container spacing={3}>
              ...
              >
                <CardContent sx={{ flexGrow: 1 }}>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      {performance.availableSeats} / {performance.availableSeats + performance.bookedSeats} {t('seats available')}
                    </Typography>
                  </Box>
                  ...
                  <Box sx={{ mt: 2 }}>
                    ...
                    >
                      {performance.availableSeats > 0 
                        ? t('{{count}} seats left', { count: performance.availableSeats }) 
                        : t('Sold Out')}
                    </Typography>
                  </Box>
                </CardContent>
                ...
                <CardActions sx={{ p: 2, pt: 0 }}>
                  ...
                  >
                    {performance.availableSeats === 0 ? t('Sold Out') : t('Select Seats')}
                  </Button>
                </CardActions>
              </Card>
            </Grid>
