...
common:
 ...
 2 -    - do not use just @ticketuno/shared, but ALWAYS use (i.e.) @ticketuno/shared/utils/layoutToSeats
 ...
 1 - OK - change `import config from '@ticketuno/shared';` to `import config from '../config';` in backend
 2 - OK - complete tickets buy process, optionally (if setup.payments.enabled) redirecting to stripe for payment
 2 - OK - allow "cancel ticket" only for operators in my bookings details
 2 - OK - a canceled ticked should be listed (as canceled) in bookings list, currently it is filtered
 3 - OK - make a method to release expired bookings (runReleaseExpiredBookingsJob), and schedule it, weekly
 ...
 3 -    - implement a real logging/auditing system (with Sentry?)
 3 -    - implement tests
 ...
 2 -    - make these components better looking: stripe/connect/success and stripe/connect/error
 3 -    - implement tests
...
Events 'canceled' when Edited show all empty fields... See database.ts...
 ...
 3 - OK - registration successful check your email ... !
 3 - OK - change Accesso riuscito! to Accesso riuscito
